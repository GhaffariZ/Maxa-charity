...
> وضعیت قابلیت: 🟢 فعال و پیاده‌سازی‌شده بر اساس کد و ساختار پایگاه داده
...
| :--- | :--- | :---: | :---: | :---: |
| `hero` | مدیریت هیروها و اسلایدرها | ✅ | ✅ | بر اساس نقش |
| `news` | مدیریت و درج اخبار | ✅ | ✅ | بر اساس نقش |
| `campaigns` | مدیریت کمپین‌های حمایتی | ✅ | ✅ | بر اساس نقش |
| `partners` | شبکه همکاران و پرسنل | ✅ | ✅ | بر اساس نقش |
| `courses` | آکادمی و دوره‌های آموزشی | ✅ | ✅ | بر اساس نقش |
| `pages` | صفحه‌ساز و کامپوننت‌ها | ✅ | ✅ | بر اساس نقش |
| `financial` | گزارش‌های مالی و تراکنش‌ها | ✅ (سراسری) | ✅ (شعبه خود) | بر اساس نقش |
| `feedback` | انتقادات و پیشنهادات 🟡 | ✅ | ✅ | بر اساس نقش |
| `medical` | پرونده‌های درمانی و بیماران | ✅ | ✅ | بر اساس نقش |
| `stands` | استندها و کارتابل سفارشات | ✅ | ✅ (شعب مجاز) | بر اساس نقش |
| `news_editor` | سردبیری و تایید نهایی خبر | ✅ | ❌ | فقط در ستاد مرکزی |
| `maxapedia` | مدیریت دانشنامه مکساپدیا | ✅ | ❌ | فقط با تایید مدیر ارشد |
| `branches` | ایجاد و تنظیمات شعب | ✅ | ❌ | ❌ |
| `ticketing` | تیکتینگ و مکاتبات داخلی | ✅ | ✅ | ✅ (سطح شعبه) |

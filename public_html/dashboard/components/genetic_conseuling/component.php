    ...
    <div class="popup-actions">
      ...
      <section class="content-column">
        ...
        <article class="article-content main-article">
                                ...
                                <h2 class="">پیشگیری از سرطان</h2>
                                <p class="wow fadeInUp">
اگر یک نفر در خانوادۀ شما به سرطان مبتلا شده باشد، خیلی زود ممکن است نگرانی‌هایی شبیه به این به سراغ شما بیاید که «آیا من و دیگر اعضای خانواده‌ام هم، در معرض ابتلا به سرطان قرار داریم؟» یا اینکه «آیا سرطان ارثی است؟» و یا «چه چیزی می تواند از ابتلای بقیه به سرطان جلوگیری کند؟» یا حتی اینکه «آیا این بیماری واگیر‌دار است؟». ما، در مکسا، خیلی خوب این نگرانی‌ها را درک می‌کنیم و البته راه‌حل‌های خوبی هم برای پاسخ به آنها داریم. خدمات مشاورۀ پیشگیری از سرطان و مشاورۀ ژنتیک در مکسا، به خانواده‌ها کمک می‌کند تا با بدست آوردن اطلاعاتی به روز، قابل اعتماد و کاربردی، خود را برای محافظت در برابر سرطان آماده سازند.
</p>
                                <h2 class="wow fadeInUp" data-wow-delay="0.8s">مشاورۀ پیشگیری از سرطان</h2>
                                <p class="wow fadeInUp" data-wow-delay="0.2s">
در عصر شبکه‌های اجتماعی، بدست آوردن اطلاعات علمی از منابع معتبر به جای اعتماد به شایعات غیرعلمی، می‌تواند از ایجاد تنش و نگرانی‌ها جلوگیری کند. گرچه هنوز عامل ایجاد بسیاری از سرطان‌ها مشخص نشده و برخی دیگر نیز به واسطۀ عواملی غیر قابل کنترل، مانند افزایش سن به وجود می‌آیند؛ با این حال بسیاری از سرطان‌ها به سادگی قابل پیشگیری هستند. به علاوه، بسیاری دیگر از سرطان‌ها نیز با کمک روش‌های غربال‌گری و تشخیص زودهنگام، به خوبی درمان می‌شوند. بنابراین، آشنا شدن با شیوه‌های پیشگیری و آزمایش‌های تشخیص زودهنگام سرطان می‌تواند به ارتقای سلامت جامعه کمک کند.
</p>
                                <p class="wow fadeInUp" data-wow-delay="0.2s">
مشاورۀ پیشگیری مکسا، با هدف پاسخ دادن به این نیاز و کمک به رفع چنین نگرانی‌هایی انجام می‌گردد. ما، در مکسا، نه تنها برای کمک به خانوادۀ بیماران؛ بلکه برای آگاهی بخشی در برابر سرطان، در سراسر جامعه تلاش می‌کنیم.
</p>
                                <p class="wow fadeInUp" data-wow-delay="0.2s">
خدمات پیشگیری سرطان در مکسا، شامل جلسات هفتگیِ مشاورۀ گروهیِ پیشگیری برای خانواده‌ها، و همچنین برگزاری رویداد‌های آگاهی بخشی عمومی در مناسبت‌های مختلف، مانند؛ هفته جهانی سرطان می‌باشد.
</p>
                                <h2 class="wow fadeInUp" data-wow-delay="0.8s">مشاورۀ ژنتیک تخصصی سرطان</h2>
                                <p class="wow fadeInUp" data-wow-delay="0.2s">
تنها ۵ الی ۱۰ درصد از موارد ابتلا به سرطان، ارثی هستند. با این حال، ما در مکسا، با انجام مشاورۀ ژنتیک، تلاش می‌کنیم تا امکان پیشگیری موثر یا درمان زودهنگام را برای افراد دارای استعداد ابتلا، فراهم کنیم. مکسا، تنها ارائه دهندۀ مشاورۀ ژنتیک تخصصی سرطان، در ایران است.
</p>
                                <p class="wow fadeInUp" data-wow-delay="0.2s">
 در جلسۀ مشاورۀ ژنتیک، اطلاعات پزشکی تمام اعضای خانواده، در یک شجره‌نامۀ ژنتیکی ترسیم می‌شود. بر اساس این شجره‌نامه، ممکن است مشاور ژنتیک، برای شما آزمایش ژنتیک تجویز کند که به کمک آن می توان ژن آسیب‌دیده (ژنی که می تواند در آینده باعث ایجاد سرطان شود) را تعیین نموده و مشخص کرد که در کدامین اعضای خانواده وجود دارد. این آزمایش ابتدا بر روی نمونه‌ای از بیمار و در صورت شناسایی ژن آسیب‌دیده، در دیگر اعضای خانواده انجام می‌شود. در ادامه، اعضایی از خانواده که دارای ژن آسیب‌دیده بوده‌اند (به اصطلاح حامل ژن جهش‌یافته) بر اساس نوع بیماری و نوع آسیب ژنی، برای انجام آزمایشات دوره‌ای یا دیگر مداخلات پزشکی، به دیگر مراکز ارجاع می‌شوند.
</p>
                                <p class="wow fadeInUp" data-wow-delay="0.2s">
اگر یکی از بستگان درجۀ اول شما در سنین کمتر از ۵۰ سال، به یکی از سرطان‌های معده، روده، لوز‌المعده (پانکراس)، پستان، رحم، تخمدان یا پروستات مبتلا گردیده، بهتر است برای انجام مشاورۀ ژنتیک و غربال‌گری سرطان‌های ارثی به مکسا مراجعه نمایید.
</p>
        </article>

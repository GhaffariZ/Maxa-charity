...
// مدیر مالی به بخش تیکت‌ها دسترسی ندارد و مستقیماً به پنل تخصصی مالی هدایت می‌شود
if (dash_is_finance_only() || dash_is_finance_user()) {
    header('Location: financial-management.php');
    exit;
}

/* توجه: سیستم تیکتینگ برای سایر کاربرانِ پنل در دسترس است و سطحِ دسترسی *درونِ* صفحه اعمال می‌شود. */

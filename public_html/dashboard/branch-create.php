...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($err === '') {
        try {
            ...
            //    بدنه = کامپوننتِ اختصاصیِ شعبه (branch-home) که هیرو + هویتِ شعبه و سپس
            //    اخبار، کمپین‌ها و دوره‌های همین شعبه را زیرِ یک پس‌زمینه‌ی مشترک نشان می‌دهد؛
            //    نه heroindexِ ستاد (که باعث کپی‌به‌نظر‌رسیدنِ صفحه می‌شد).

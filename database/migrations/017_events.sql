...
CREATE TABLE IF NOT EXISTS `events` (
  ...
  `banner_dismissible` TINYINT(1) NOT NULL DEFAULT 1,
  `banner_background` CHAR(7) NOT NULL DEFAULT '#007b7a',
  `banner_text_color` CHAR(7) NOT NULL DEFAULT '#ffffff',
  `banner_accent_color` CHAR(7) NOT NULL DEFAULT '#f4a61e',

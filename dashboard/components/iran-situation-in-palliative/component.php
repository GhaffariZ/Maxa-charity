...
<body>
  ...
  <main class="page-container">
    ...
    <header class="header-capsule">
      <h1>وضعیت مراقبت های حمایتی و تسکینی در ایران</h1>
    ...
    <div class="popup-actions">
      ...
      <section class="content-column">
        ...
        <article class="article-content main-article">
                                ...
                                <h2 class="">وضعیت مراقبت های حمایتی و تسکینی در ایران</h2>
                                <p class="wow fadeInUp">
در حال حاضر مراقبت های حمایتی و تسکینی در ایران به صورت سیستماتیک ارائه نمی‌شود. در گزارش‌های سالانه موسسه بین المللی نظارت بر مراقبت های پایان عمر و سازمان جهانی بهداشت، وضعیت ارائه مراقبت های حمایتی و تسکینی درکشور‌های مختلف بررسی شده. کشور‌های جهان بر اساس وضعیت ارائۀ مراقبت های تسکینی به ۴ گروه اصلی تقسیم می‌شوند.
</p>
                                <p class="wow fadeInUp" data-wow-delay="0.2s">
گروه ۱) کشور‌های فاقد هیچ فعالیت شناخته شده در زمینۀ مراقبت های حمایتی و تسکینی؛
</p>
                                <p class="wow fadeInUp" data-wow-delay="0.2s">
گروه ۲) کشور‌هایی که صرفا در حال ظرفیت سازی برای ارائۀ مراقبت های حمایتی و تسکینی هستند و این خدمات در آن‌ها ارائه نمی‌شود؛
</p>
                                <p class="wow fadeInUp" data-wow-delay="0.2s">
گروه ۳) کشور‌هایی که در آن‌ها مراقبت های حمایتی و تسکینی در برخی مناطق و توسط مراکز محدود ارائه می‌شود. این کشور‌ها خود به دو زیر گروه تقسیم می‌شوند.
</p>
                                <p class="wow fadeInUp" data-wow-delay="0.2s">
گروه ۳ – الف) خدمات ناقص، بدون حمایت رسمی، وابسته به خیرین، محدودیت در دسترسی به مورفین، مراقبت ها بیشتر در منزل ارائه می‌شود و آموزش نیروی متخصص در این کشور‌ها انجام نمی‌شود.
</p>
                                <p class="wow fadeInUp" data-wow-delay="0.2s">
گروه ۳ – ب) حمایت کافی از خدمات در برخی از مناطق وجود دارد. وجود منابع مالی مناسب برای ارائۀ مراقبت ها، دسترسی مناسب به مورفین، مراقبت ها در پاره‌ای از موارد و بصورت مستقل توسط برخی مراکز درمانی ارائه می‌شود و آموزش نیروی متخصص تا حدی وجود دارد.
</p>
                                <p class="wow fadeInUp" data-wow-delay="0.2s">
گروه ۴) کشور‌هایی که در آن‌ها مراقبت های حمایتی و تسکینی در نظام سلامت ادغام شده و خدمات آن در هماهنگی و بصورت یکپارچه با دیگر مراقبت های بهداشتی و درمانی قرار دارد.
</p>
                                <h2 class="wow fadeInUp" data-wow-delay="0.8s">این دسته‌بندی بر اساس معیار‌های زیر انجام شده است.</h2>
                            <ul class="wow fadeInUp" data-wow-delay="1.2s">
                                <li>میزان پوشش مراقبت های حمایتی و تسکینی در کشور؛</li>
                                <li>سطح آگاهی جامعه از مراقبت های حمایتی و تسکینی؛</li>
                                <li>دسترسی به اپیوئیدها؛</li>
                                <li>کیفیت آموزش و تربیت متخصصین مراقبت های حمایتی و تسکینی؛</li>
                                <li>هزینۀ مراقبت های حمایتی و تسکینی؛</li>
                                <li>ساختار و سطوح ارائه خدمات؛</li>
                                <li>وجود سیاست‌های کشوری برای مراقبت های حمایتی و تسکینی؛</li>
                                <li>وجود طیف کامل مراقبت های حمایتی و تسکینی؛</li>
                                <li>هماهنگی مراقبت‌ها با جریان اصلی درمان و</li>
                                <li>وضعیت پژوهش در زمینۀ مراقبت های حمایتی و تسکینی.</li>
                            </ul>
                                <p class="wow fadeInUp" data-wow-delay="0.2s">
در گزارشی که در سال ۲۰۱۴ توسط سازمان جهانی بهداشت منتشر شده است، ایران در گروه «۳ – ب»  این گزارش قرار دارد. البته جایگاه  ایران نسبت به دورۀ قبلی ارزیابی مربوط به سال ۲۰۰۶، که ایران در گروه ۲ قرار داشته ، ارتقاء یافته است.
</p>
...
در حال حاضر معدود مراکز مراقبت های حمایتی و تسکینی موجود در ایران به صورت محلی فعالیت نموده و وجود نظامی یکپارچه که مدیریت و استاندارد سازی ساختار، فرایند‌های عملیاتی و پروتکل‌های آموزشیِ مربوط به مراقبت های حمایتی و تسکینی، را برعهده داشته باشد، وجود ندارد.
                                ...
                                <h2 class="wow fadeInUp" data-wow-delay="0.8s">جایگاه ایران در جنبه‌های گوناگون مراقبت های حمایتی و تسکینی و کیفیت مرگ</h2>
                                <p class="wow fadeInUp" data-wow-delay="0.2s">
طبق «فهرست کیفیت مرگ؛ رتبه بندی کشور‌ها در مراقبت های حمایتی و تسکینی» (The 2015 Quality of Death Index. Ranking palliative care across the world) که توسط بنیاد لیِن (Lien) و با همکاری سرویس اطلاعاتی موسسۀ اکونومیست (The Economist Intelligence Unit) در سال 2015 منتشر شده است، 80 کشور از جنبه‌های گوناگون مراقبت های حمایتی و تسکینی و کیفیت مرگ مورد ارزیابی قرار گرفته اند.
                                ...
                                <h2 class="wow fadeInUp" data-wow-delay="0.8s">نسبت استفاده کنندگان از مراقبت های حمایتی و تسکینی</h2>
                                <p class="wow fadeInUp" data-wow-delay="0.2s">
درصد تخمینی کسانی که در هنگام مرگ از مراقبت های حمایتی و تسکینی بهره می‌برند نسبت به تمام کسانی که در زمان مرگ به این مراقبت‌ها احتیاج دارند. بر اساس این ارزیابی، ظرفیت ارائۀ این مراقبت های حمایتی و تسکینی در ایران بسیار اندک است به شکلی که در ایران از هر هزار نفری که در زمان مرگ به این مراقبت‌ها احتیاج دارند، تنها حدود ۱ نفر از آن بهره می‌برد.
</p>
                        <!-- Service Featured Image Start -->
                        <div class="service-featured-image">
                            <figure class="image-anime reveal">
                        ...
                        <!-- Service Featured Image End -->
                                ...
                                <h2 class="wow fadeInUp" data-wow-delay="0.8s">وجود نیروی متخصص و حرفه ای</h2>
                                <p class="wow fadeInUp" data-wow-delay="0.2s">
وجود کسانی که در زمینۀ مراقبت های حمایتی و تسکینی آموزش دیده باشند رابطۀ مستقیمی با توسعۀ این خدمات در هر کشور دارد. مراقبت های حمایتی و تسکینی در بسیاری از کشور‌های پیشرفته به عنوان یک تخصص جداگانه شناخته شده و تدریس می‌شود. ایران در ارزیابی سال ۲۰۱۵ اکونومیست از ۸۰ کشور، به جایگاهی بهتر از رتبۀ ۷۸ ام در وجود نیروی حرفه‌ای برای ارائۀ مراقبت‌های تسکینی دست نیافته است.
</p>
                                <h2 class="wow fadeInUp" data-wow-delay="0.8s">مقرون به صرفه بودن مراقبت های حمایتی و تسکینی</h2>
                                <p class="wow fadeInUp" data-wow-delay="0.2s">
حمایت دولتی و فعالیت خیریه‌ها باعث سهولت دسترسی طبقات مختلف جامعه به مراقبت های حمایتی و تسکینی می‌شود. بر خلاف ضعف شدید ایران در ارائۀ این مراقبت‌ها در نبود حمایت‌های دولتی و پوشش بیمه ای، ایران در رتبۀ ۵۶ ام در رده بندی مقرون به صرفه بودن مراقبت های حمایتی و تسکینی بین ۸۰ کشور بررسی شده قرار گرفته است.  کسب این رتبه به لطف فعالیت خیریه‌ها و سازمان‌های مردم نهاد در عرصه مراقبت های حمایتی و تسکینی بدست آمده است. مراکزی که این خدمات را به صورت رایگان در اختیار بیمار و خانوادۀ او قرار می‌دهند یا به شکل دیگری به ایشان در فراهم کردن شرایط مورد نیاز بیمار کمک می‌کنند.  
</p>
                                <h2 class="wow fadeInUp" data-wow-delay="0.8s">ارتباط جامعه با مراقبت های حمایتی و تسکینی</h2>
                                <p class="wow fadeInUp" data-wow-delay="0.2s">
ایران در رتبۀ ۷۷ در ارتباط جامعه با مراقبت های حمایتی و تسکینی قرار دارد. آگاهی جامعه از نقش این مراقبت‌ها، مطالبه گری اجتماعی، فعالیت‌های داوطلبانه و همکاری نیکوکاران، اساس پیوند میان مراقبت های حمایتی و تسکینی و جامعه است. شناخت بیشتر جامعه  نسبت به این خدمات، از یک سو باعث افزایش تمایل و درخواست برای راه اندازی آن و از طرف دیگر، افزایش سرمایه‌های اجتماعی برای توسعۀ آن، می‌شود.
</p>
                        <!-- Service Featured Image Start -->
                        <div class="service-featured-image">
                            <figure class="image-anime reveal">

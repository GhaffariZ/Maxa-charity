...
<body>
  ...
  <main class="page-container">
    ...
    <header class="header-capsule">
      <h1>مراقبت های بازتوانی و توانبخشی</h1>
    ...
    <div class="popup-actions">
      ...
      <section class="content-column">
        ...
        <article class="article-content main-article">
                                ...
                                <h2 class="">مراقبت های بازتوانی و توانبخشی</h2>
                                <p class="wow fadeInUp">
بازتوانی یا توان‌بخشی، به برنامه‌های درمانی گفته می‌شود که به فرد کمک می‌کند که پس از یک بیماری یا آسیب، توانِ ازدست رفتۀ خود را دوباره به دست آورد. برای بازتوانی، از دارو استفاده نمی‌شود؛ بلکه فرد به کمک تمرینات و به تدریج، توانِ خود را باز می‌یابد. بازتوانی ممکن است جنبۀ حسی، حرکتی یا شناختی و روانی داشته باشد. بازتوانی به شکل‌های گوناگون و برای پاسخ به نیازهای مختلف ارائه می‌شود. فیزیوتراپی، حرکات اصلاحی ورزشی، طب فیزیکی، کاردرمانی، کنترل لنف ادم، گفتار درمانی، بازتوانی و روان‌شناختی، مثال‌هایی از فعالیت‌هایی است که با هدف توانبخشی انجام می‌شود.
</p>
                                <p class="wow fadeInUp" data-wow-delay="0.2s">
بیماران مبتلا به سرطان نیز، مانند بسیاری دیگر از مبتلایان به بیماری‌های مزمن، ممکن است با چالش‌هایی روبرو شوند که بر عملکرد آنان اثر بگذارد. فعالیت تومور، انجام جراحی و دیگر درمان‌های سرطان، کم شدن روحیه و افسردگی، وجود دیگر بیماری‌ها و نیاز به بستری طولانی مدت ممکن است باعث کاهش توان او برای انجام کارها شود. توان‌بخشی به بیمار کمک می‌کند استقلال خود را حفظ کند و درد و رنج او را کاهش دهد. مکسا خدمات توان‌بخشی مانند فیزیوتراپی، کاردرمانی، درمان لَنْفْ اِدِم را به صورت رایگان به بیماران مبتلا به سرطان ارائه می‌دهد.
</p>
                                <h2 class="wow fadeInUp" data-wow-delay="0.8s">فیزیوتراپی</h2>
                                <p class="wow fadeInUp" data-wow-delay="0.2s">
گاهی سرطان باعث کاهش توان حرکت و ادارۀ خود و کار‌ها، توسط بیمار می‌شود. درمان سرطان هم ممکن است باعث ضعف عضلات، به‌هم خوردن توازن حرکات، تغییر در شکل اندام‌ها و مشکلات حرکتی شود. به علاوه، بیمارانِ وابسته به تخت و بیمارانی که برای مدت طولانی بستری می‌شوند، به سبب کم تحرکیِ بلند مدت، به تدریج دچار اختلالات حرکتی و کاهش توان اندام‌های حرکتی می‌شوند. انجام تمرینات فیزیوتراپی نقش قابل توجهی در پیشگیری از این عوارض و درمان آنها ایفا می‌کند. تمرینات فیزیوتراپی و اصلاحی، از پیشرفت چنین اختلالاتی جلوگیری می‌کند و نمی‌گذارد ضعف حرکتی بیمار به مرحلۀ غیرقابل برگشت برسد. این تمرینات فیزیوتراپی، شامل انجام حرکات مختلف برای تقویت اندام‌های حرکتی می‌باشد. فیزیوتراپ به بیمار یاد می‌دهد که چطور این تمرینات را خود به تنهایی یا با کمک اطرافیان خود انجام دهد. این تمرینات ممکن است در منزل، در مرکزِ بازتوانی و با استفاده از دستگاه‌های تمرینی استاندارد، در سالن‌های ورزشی و یا در استخر آب درمانی انجام شود.
</p>
                                <h2 class="wow fadeInUp" data-wow-delay="0.8s">کاردرمانی</h2>
                                <p class="wow fadeInUp" data-wow-delay="0.2s">
ممکن است درمان سرطان و یا فعالیت تومور، به ایجاد مشکلات حرکتی برای بیمار بیانجامد. این مشکلات حرکتی ممکن است روی توانایی بیمار برای انجام کارهای روزانه اثر بگذارد و به مرور باعث کاهش استقلال بیمار و وابستگی او به اطرافیان شود. کار‌درمانی به بهبود توانایی انجام کارهای روزانه و تطابق محیط زندگی با نیاز‌های خاص بیمار کمک می‌کند. کاردرمانگر با اعمال مدیریت در محیط زندگی یا مراقبت و تجویز توصیه‌ها و تجهیزات مناسب برای بیمار سعی می‌کند تا حداکثر استقلال عملکردی برای زندگی روزمره و همچنین حداکثر امنیت و رفاه را برای بیمار فراهم آورد.
</p>
                                <h2 class="wow fadeInUp" data-wow-delay="0.8s">پیشگیری و کنترل لنف ادم</h2>
                                <p class="wow fadeInUp" data-wow-delay="0.2s">
لنف، مایعی است که در رگ‌های لنفی و به‌طور کلی‌تر، در سراسر دستگاه لَنْفاوی گردش می‌کند. مایعِ میان بافتی، که منشاء آن، پلاسمای خون (مایع بدون سلول خون) است، پس از گردش در بافت، به رگ‌های لَنْفی وارد می‌شود. این مایع پس از ورود به رگ‌های لَنْفی، لَنْفْ خوانده می‌شود. گاهی در طول جراحی پستان، برای اطمینان از اینکه همۀ سلول‌های سرطانی برداشته شده‌اند، جراح، رگ‌ها و گره‌های لَنْفی اطراف پستان را هم بر می‌دارد. از آنجا که بخشی از گره‌ها و رگ‌های لَنْفیِ دست و پستان، مشترک هستند، در چنین بیمارانی، مایع میان بافتی نمی‌تواند وارد دستگاه لنفاوی شود و از این‌رو در بافت‌هایی مانند دست و بازو جمع می‌شود. چنین مسئله‌ای ممکن است در دیگر جراحی‌ها و در قسمت‌های دیگر بدن یا حتی به دنبال پرتو درمانی، شیمی درمانی و… ایجاد ‌شود. تجمع مایع در بافت، سبب تورم آن اندام می‌شود. به این وضعیت لَنْفْ اِدِم گفته می‌شود. لنف ادم می‌تواند باعث درد، سنگینی و التهاب در اندام شود و بیمار را از انجام فعالیت‌های روزمره باز ‌دارد. بیشتر افرادی که برای درمان سرطان، تحت جراحیِ برداشتن پستان قرار می‌گیرند دچار لَنْفْ اِدِم می‌شوند. این درحالی است که با مراجعه به لنفوتراپیست، و یادگیری ماساژهای تخصصی ، مراقبت‌های لازم و نحوه‌ی فعالیت با دستِ درگیر، می‌توان از لنف ادم پیشگیری و آنرا کنترل کرد.
</p>
                                <p class="wow fadeInUp" data-wow-delay="0.2s">
پزشک لنفوتراپیست اقدامات درمانی لازم را برای پیشگیری، تشخیص و درمان لنف ادم را انجام می‌دهد. اقداماتی مثل آموزشِ روشِ پیشگیری از لَنْفْ اِدِم، انجام ویزیت‌های مکرر برای درمان تورم، استفاده از دستگاه‌ها و ابزارهای کمکی برای تخلیه‌ی لنف و آموزش انجام روش‌های درمانی در منزل، برای جلوگیری از بروز مجدد یا پیشرفت عارضه.
</p>

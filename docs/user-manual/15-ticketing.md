...
> وضعیت قابلیت: 🟢 فعال و پیاده‌سازی‌شده بر اساس `tickets.php` و مایگریشن دیتابیس `002_ticketing.sql`
...
4. **اولویت تیکت (Priority):**
   * 🟢 **عادی (`normal`):** امور روزمره اداری و سوالات عمومی.
   * 🟡 **کم (`low`):** پیشنهادات یا درخواست‌های با مهلت زمانی آزاد.
   * 🔴 **فوری (`high`):** موارد اورژانسی مربوط به تأمین تجهیزات بیمار یا مسدود شدن درگاه پرداخت.
...
| :--- | :---: | :--- |
| **باز (`open`)** | 🟢 | تیکت تازه ثبت شده و در انتظار بررسی و پاسخ مخاطب است. |

...
1. ابتدا با مطالعه [نقش‌ها و دسترسی‌ها](02-roles-and-permissions.md)، از نقش خود در سامانه مطلع شوید.
2. سپس به [راهنمای ورود و مدیریت حساب](03-login-and-account.md) مراجعه کرده و وارد پنل مدیریت شوید.

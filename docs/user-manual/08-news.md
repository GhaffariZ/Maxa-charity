...
> وضعیت قابلیت: 🟢 فعال و پیاده‌سازی‌شده بر اساس `news-create.php`, `news-list.php`, `news-save.php`, `news-status-update.php` و مایگریشن‌های 002، 007، 008
